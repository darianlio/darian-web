    ...
    render() {
        return (
            <StaticQuery
                query = {graphql`
                    query {
                        file(relativePath: { eq: "kevin.png" }) {
                            childImageSharp {
                                fluid(maxWidth: 1000) {
            ...
            <div className="about-container">
                <div className="about-grid">
                    ...
                    <h1 className="about-title"><span>HELLO</span><br/> I'm Darian.</h1>
                    <div className="about-para box1">
                        <h1>Born in 1997</h1>
